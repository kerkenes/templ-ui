...
`)
	...
	for _, category := range categoryOrder {
		...
		for _, comp := range items {
			docURL := fmt.Sprintf("https://templ-ui.muratkirazkaya.com/docs/components/%s", comp.Name)
