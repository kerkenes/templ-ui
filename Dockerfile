...
RUN curl -s https://api.github.com/repos/kerkenes/templ-ui/releases/latest | grep tag_name | cut -d '"' -f 4 > version.txt || echo "unknown" > version.txt
...
ENV BASE_URL=https://templ-ui.muratkirazkaya.com
