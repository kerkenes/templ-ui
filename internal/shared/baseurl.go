...
const canonicalURL = "https://templ-ui.muratkirazkaya.com"
...
// https://templ-ui.muratkirazkaya.com, task dev sets http://localhost:8090, stable falls
// back to the default.
func BaseURL() string {
...
// merely contain the host (e.g. https://templ-ui.muratkirazkaya.com as a documented CLI
