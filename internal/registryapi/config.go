...
//   - BASES is ["base"]: templ-ui has exactly one Go implementation of every
...
//     templ-ui pendant (a consumer project is any Go module).
...
import (
	...
	"github.com/kerkenes/templ-ui/internal/preset"
)
...
// Bases: templ-ui ships one implementation, so only "base" exists (shadcn:
// base | aria | radix).
...
// IconLibraryNames in shadcn/icons iconLibraries key order. templ-ui compiles
