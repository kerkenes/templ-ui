...
Want to build your theme visually? Use [templ-ui Create](/create) to preview colors, radius, fonts, and icons, then generate a preset for your project.
...
`tailwind.baseColor` controls the default token values generated for your project when you run `init` or use a preset. Pick one on [templ-ui Create](/create) to generate a theme with it.
