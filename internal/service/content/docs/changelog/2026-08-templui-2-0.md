...
```shell
go install github.com/kerkenes/templ-ui/cmd/templui@latest
```

This is a beta. If something looks off, [open an issue](https://github.com/kerkenes/templ-ui/issues/new/choose).
