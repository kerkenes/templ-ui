...
The chart elements mirror the Recharts composition one to one. This means you're not locked into a templ-ui abstraction: shadcn and Recharts chart examples translate directly, element for element.
